...
run Step_Counter_Thread_eaaf0193_d123_4b07_8fc9_a27efcf95439()
  ...
  #set_tool_voltage(24)                          # <-- COMENTAR (No existeix a CB3)
  set_gravity([0.0, 0.0, 9.82])
  #set_safety_mode_transition_hardness(1)       # <-- COMENTAR (No existeix a CB3)
  
  # CANVIAR 'set_target_payload' per 'set_payload' (sense el tercer paràmetre de la matriu d'inèrcia):
  set_payload(0.780000, [0.000000, 0.000000, 0.064000])
  
  set_tcp(p[0.0,0.0,0.2286,0.0,0.0,0.0])
  
  # COMENTAR totes les línies de dominis analògics següents (tampoc existeixen a CB3 via script):
