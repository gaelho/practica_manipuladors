def unnamed():
  ...
  step_count_c8021e56_203c_45d0_b8cd_0d182e8edd6b = 0.0
  thread Step_Counter_Thread_dfe3cc62_05d5_454d_ac71_188d052d2095():
    while (True):
      step_count_c8021e56_203c_45d0_b8cd_0d182e8edd6b = step_count_c8021e56_203c_45d0_b8cd_0d182e8edd6b + 1.0
      sync()
    end
  end
  run Step_Counter_Thread_dfe3cc62_05d5_454d_ac71_188d052d2095()
  ...
  global zmastcp=p[0,0,0.18659,0,-0,0]
  ...
  thread ContinuousPulseInstallationComponent0():
    while (True):
  ...
  continuousPulse0 = run ContinuousPulseInstallationComponent0()
  while (True):
    $ 1 "Programa de robot"
